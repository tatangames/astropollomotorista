...
import com.tatanstudios.astropollomotorista.adaptadores.ordenes.PendientesOrdenesAdapter;
...
public class FragmentPendientesOrdenes extends Fragment {
    ...
    PendientesOrdenesAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View vista = inflater.inflate(R.layout.fragment_pendiente_ordenes, container, false);
        ...
        ((PrincipalActivity)getActivity()).setActionBarTitle(getString(R.string.ordenes_pendientes));
        ...
        adapter = new PendientesOrdenesAdapter();
    ...
    void peticionServidor(){
        ...
        compositeDisposable.add(
                service.verOrdenesPendientes(id)
                        ...
                        .subscribe(apiRespuesta -> {
                                    ...
                                    if(apiRespuesta != null) {
                                        ...
                                        if(apiRespuesta.getSuccess() == 1){
                                            ...
                                            adapter = new PendientesOrdenesAdapter(getContext(), apiRespuesta.getOrdenes(), this);
                                            recyclerOrdenes.setAdapter(adapter);
    ...
    public void abrirOrdenes(int ordenid, String telefono){
        Intent res = new Intent(getActivity(), EstadoPendienteOrdenActivity.class);
        res.putExtra("KEY_ORDEN", ordenid);
        res.putExtra("KEY_TELEFONO", telefono);
