...
public class EntregandoOrdenesAdapter extends RecyclerView.Adapter<EntregandoOrdenesAdapter.MyViewHolder> {

    // carga los servicios por zona

    Context context;
    List<ModeloOrdenesList> modeloTipo;
    FragmentEntregaOrdenes fTipoServicio;

    public EntregandoOrdenesAdapter(){}

    public EntregandoOrdenesAdapter(Context context, List<ModeloOrdenesList> modeloTipo, FragmentEntregaOrdenes fTipoServicio){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.cardview_entregando_ordenes, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.setListener((view, position1) -> {
            ...
            String tel = modeloTipo.get(position).getTelefono();

            fTipoServicio.abrirOrdenes(pos, tel);
        });
    }
