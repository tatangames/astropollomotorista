...
public class ProductoEntregandoOrdenAdapter extends RecyclerView.Adapter<ProductoEntregandoOrdenAdapter.MyViewHolder>  {

    Context context;
    public ArrayList<ModeloProductoList> modeloTipo;
    EstadoEntregandoOrdenActivity estadoEntregandoOrdenActivity;
    ...
    public ProductoEntregandoOrdenAdapter(){}

    public ProductoEntregandoOrdenAdapter(Context context, ArrayList<ModeloProductoList>  modeloTipo, EstadoEntregandoOrdenActivity estadoEntregandoOrdenActivity){
        this.context = context;
        this.modeloTipo = modeloTipo;
        this.estadoEntregandoOrdenActivity = estadoEntregandoOrdenActivity;
    }
